...
async function getShippoQuote(weightLb, addressTo) {
  ...
  const dims = weightLb <= 1
    ...
    : weightLb <= 4
      ? { length: '11', width: '8.5', height: '4', distance_unit: 'in' }
      : { length: '13', width: '11', height: '6', distance_unit: 'in' };
...
module.exports = { calculateShipping, itemCount, MINIMUM_ITEMS, DISCOUNT_CAP_ITEM_COUNT };
